...
class ViewController: UIViewController, CanvasDelegate {
  ...
  @IBOutlet weak var canvasView: DrawableCanvasView!
  ...
  override func viewDidLoad() {
    super.viewDidLoad()
    setupVision()
    canvasView.setDelegate(delegate: self)
  }
  ...
  func handleClassification (request:VNRequest, error:Error?) {
    ...
    print("Recognised:  \(String(describing: classifications.first))")
  ...
  fileprivate func recogniseDigit() {
